...
Los elementos de componibilidad y que no tienen ningún estado se denominan elementos sin estado. Una forma fácil de crear un elemento de componibilidad sin estado es usar la elevación de estado.

La toma de estado en Compose es un patrón asociado al movimiento de estado a un llamador de un elemento de componibilidad a fin de quitarle el estado al elemento. El patrón general para la elevación de estado en Jetpack Compose es reemplazar la variable de estado con dos parámetros:
...
y la elevación de estado es la forma en que implementamos esta arquitectura en Compose.
Puedes obtener más información al respecto en la documentación de la arquitectura de Compose.
...
+Separación: El estado de una función de componibilidad sin estado se puede almacenar en cualquier lugar.
    Por ejemplo, en un ViewModel.
...
Debes diseñar tus elementos componibles de modo que tengan la menor cantidad de estado posible y permitir que se eleve cuando convenga,
exponiéndolos en la API del elemento componible.
* */
